...
1. **Given** I select a pay period **When** the summary loads **Then** I see totals for the pay period and a breakdown
   by day.
2. **Given** I view a day in the pay period **When** I expand it **Then** I see a breakdown by code and the day total.
3. **Given** pay periods are PP1 (1–15) and PP2 (16–end) **When** I navigate between pay periods **Then** boundaries
