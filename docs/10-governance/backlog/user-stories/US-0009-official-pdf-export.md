...
- ADRs: [ADR-0012](../02-adr/ADR-0012-pdf-export-pipeline.md),
  [ADR-0018](../02-adr/ADR-0018-pdf-rendering-html-chromium.md), [ADR-0033](../02-adr/ADR-0033-testing-strategy.md)

## Acceptance Criteria (Given/When/Then)

1. **Given** I am viewing a report (pay period) **When** I choose Export PDF **Then** I receive a generated PDF.
2. **Given** a PDF is generated **When** I open it **Then** it includes title, date range, generation timestamp, page
   numbers, and any rule warnings.
