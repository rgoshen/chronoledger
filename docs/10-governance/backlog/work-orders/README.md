...
This folder exists for **exceptional** cases only. The default execution unit is the **slice** (`docs/10-governance/backlog/slices/SL-####...`) which contains an in-file **Work Breakdown** checklist.
